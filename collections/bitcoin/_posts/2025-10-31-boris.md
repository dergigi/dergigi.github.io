...
Back to Boris. Boris wasn't even called Boris in the beginning. I think I called it "markstr" or something terrible like that. I'm glad I renamed it, but I think the rename is the reason why I can't find the initial prompt. Here's the earliest prompt I was able to find: `Let's rename the app to "Boris"`.
...
What started as a Demo Day experiment quickly became an obsession. After the demo (which worked, by the way, miraculously), I went back at it and did more prompting. And more prompting after that. Next day? More prompting. I couldn't stop. I was obsessed.

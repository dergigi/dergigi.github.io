...
["Don't trust, verify."](/2020/04/27/dear-family-dear-friends/#:~:text=Don't%20trust%2C%20verify) That's how the slogan goes. And that's part of the issue: it became a slogan, not a practice.

But here's the issue: it's an impossible problem. How paranoid should you be? What should you trust, and what might be compromised? The reality is that everything and everyone might be compromised. Your spouse might be an agent, [your compiler might have an undetectable backdoor](/2019/04/02/technological-teachings-of-bitcoin/), someone might listen to your every conversation by measuring the vibrations of your window with a laser. There is no end to it. Your skepticism has to bottom out somewhere. If it doesn't, your life will be indistinguishable from the life of the psychotic.
...
It should've never ended up in production because [entropy generation](/2019/12/22/bitcoin-s-eternal-struggle/#entropy) is the most critical part of any hardware wallet. Users trust that this part works, no matter how often you encourage them to [roll the dice](https://21lessons.com/16/). Low entropy should be treated as a catastrophic failure mode because it is *impossible* to patch after the fact.

...
- [∀i≤c](https://en.wikipedia.org/wiki/Speed_of_light#Upper_limit_on_speeds) [^1]
- [P!=NP](https://en.wikipedia.org/wiki/P_versus_NP_problem#P_%E2%89%A0_NP) [^2]
- [Life is worth living](https://en.wikipedia.org/wiki/Life_Is_Worth_Living) [^3]
- [There's no free lunch](https://en.wikipedia.org/wiki/First_law_of_thermodynamics) [^4]
- [Free Speech is desirable](https://en.wikipedia.org/wiki/Freedom_of_speech) [^5]
...
[^1]: No information can travel faster than the speed of light.
[^2]: Cryptography works and will continue to work. "[...] somehow [the universe smiles on encryption](https://bitcoin-resources.com/books/cypherpunks).
[^3]: Existence is [Real and Good](https://www.goodreads.com/book/show/40311194). Neither Nihilism nor Solipsism are desirable.
[^4]: We can't have something for nothing. Freedom requires [responsibility](https://archive.is/U6iJ4); electronic cash requires [time](/time); time requires [heat](/threads/time-requires-heat).
[^5]: It is desirable because freedom is desirable over tyranny, and the first step of any tyrant is to [restrict speech](https://bitcoin-resources.com/books/nineteen-eighty-four1984), silence dissidents, and [burn books](https://bitcoin-resources.com/books/fahrenheit451). The second step is genocide.
